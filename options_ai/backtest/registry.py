...
class StrategyDefinition:
    ...
    def _build_cfg(self, canonical_params: dict[str, Any]) -> DebitBacktestConfig:
        ...
        return DebitBacktestConfig(
            ...
            entry_retrace_pct=float(g("entry_retrace_pct", 0.0)),
            entry_retrace_timeout_sec=int(g("entry_retrace_timeout_sec", 90)),
            entry_retrace_fallback=str(g("entry_retrace_fallback", "enter_now")),
...
class DebitSpreadsStrategy(StrategyDefinition):
    ...
    def validate_and_normalize(self, payload: dict[str, Any], *, strict: bool) -> dict[str, Any]:
        ...
        canon: dict[str, Any] = {
            ...
            "entry_retrace_pct": f("entry_retrace_pct", 0.0),
            "entry_retrace_timeout_sec": i("entry_retrace_timeout_sec", 90),
            "entry_retrace_fallback": e("entry_retrace_fallback", "enter_now", ["enter_now", "skip"]),
